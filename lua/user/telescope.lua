...
vim.keymap.set('n', '<leader><leader>', function() require('telescope.builtin').buffers() end, { desc = '[ ] Find existing buffer.' })
vim.keymap.set('n', '<leader>st', function() require('telescope').extensions.aerial.aerial() end, { desc = '[S]earch [A]erial Symbols' })
